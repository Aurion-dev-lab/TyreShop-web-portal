    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-sans">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-10">
          <div className="w-16 h-16 bg-emerald-600 rounded-2xl flex items-center justify-center text-white shadow-2xl shadow-emerald-200 mb-4">
            <FiTool className="text-3xl" />
          </div>
          <h2 className="text-3xl font-black text-slate-900 tracking-tight">
            Tyre<span className="text-emerald-600">Shop</span>
          </h2>
        ...
        <div className="bg-white rounded-[2rem] shadow-xl shadow-slate-200/60 border border-slate-100 p-8 md:p-10 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="admin"
                  className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-transparent rounded-2xl focus:bg-white focus:border-emerald-500 transition-all outline-none text-slate-700 font-medium"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 rounded-2xl focus:bg-white transition-all outline-none text-slate-700 font-medium ${error ? 'border-rose-500 focus:border-rose-500' : 'border-transparent focus:border-emerald-500'
                    }`}
                />
              </div>
              {error && (
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-slate-900 text-white rounded-2xl font-bold text-lg hover:bg-emerald-600 hover:-translate-y-1 transition-all shadow-lg shadow-slate-200 disabled:bg-slate-400 disabled:translate-y-0 group"
            >
